...
if __name__ == "__main__":
    ...
    bert =  AutoModel.from_pretrained(args.bert_pretrain).cuda()
    if args.bert_pretrain:
        ...
        pretrained_dict = {k.replace("bert.", ""): v for k, v in pretrained_dict.items() if k.replace("bert.", "") in model_dict}
